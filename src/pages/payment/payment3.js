...
const Payment3 = () => {
    ...
    return(
        ...
        (
        <div className='payment_container_3'>
            <div className="payment_wrapper_left">
                <img src="/pic/shop_pic/book2.webp" alt="상품 이미지" className='payment_product_img'/>
            </div>
            <div className="payment_wrapper_right">
                <div className="payment_wrapper_right_box">
                    ...
                    <Link to='/paycomplete3' className='purchase_btn'>구매하기</Link>
                </div>
            </div>
        </div>
        )}
